...
namespace InsanityMod.Managers
{
    internal static class InsanityHud
    {
        ...
        private static void TryAttach()
        {
            ...
            if (hud == null || hud.PlayerInfo == null) return;
            var parent = hud.PlayerInfo.canvasGroup?.transform;
            ...
            _ringBg.color         = new Color(0.15f, 0.15f, 0.15f, 0.6f);
